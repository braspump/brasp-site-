    ...
    <section class="container mx-auto px-4 py-16 grid gap-6 md:grid-cols-3">
      ...
      <div class="group rounded-2xl bg-card border border-border overflow-hidden shadow-sm hover:shadow-2xl transition flex flex-col">
        ...
        <div class="p-6 flex-1 flex flex-col">
          ...
          <a href="<?php echo esc_url( home_url( '/produto/unidade-suctora' ) ); ?>" class="mt-5 inline-flex items-center justify-center gap-2 rounded-full bg-brand-gold px-5 py-3 font-bold text-brand-gold-foreground hover:brightness-110 transition">
